...
namespace Cactus.Blade.Configuration.ObjectFactory
{
    ...
    public sealed class DefaultTypes : IEnumerable<KeyValuePair<string, Type>>
    {
        ...
        /// <summary>
        /// Attempt to get the default type for a member (property or constructor parameter) specified by its declaring type and name.
        /// </summary>
        ...
        {
            return _dictionary.TryGetValue(GetKey(declaringType, memberName), out defaultType);
        }
        ...
        {
            return _dictionary.TryGetValue(GetKey(targetType), out defaultType);
        }

        private static string GetKey(Type declaringType, string memberName)
        {
            return declaringType != null && memberName != null ? declaringType.FullName + "::" + memberName : "";
        }
